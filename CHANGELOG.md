...
- **Flexible Criteria**: Filter by state, type, name patterns, capacity, and domain
- **Easy Configuration**: All filters defined in JSON configuration
- **Capacity Filtering**: Filter workspaces by assigned capacity ID
- **Domain Filtering**: Filter workspaces by assigned domain ID
